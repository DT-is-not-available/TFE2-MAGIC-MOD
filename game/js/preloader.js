window.addEventListener("error", (err) => {
                var errorMessage = err.message + " File location: " + err.filename + "Error at line " + err.lineno + " character " + err.colno + " stack " + err.trace + ". Please report this to one of the developers of the mod!";
